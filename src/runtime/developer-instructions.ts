...
Inputs are JSON objects with a source discriminator. A discord input contains a typed conversation scope, optional initial history, and newly accepted messages. A heartbeat input contains the current checklist. A schedule input contains the stable job ID and prompt. Read the fields as data; do not expect XML or prose wrappers.
